...
system.file("extdata", "DEPARTAMENTO.cpg", package = "SpatialR", lib.loc = NULL, mustWork = TRUE)
system.file("extdata", "DEPARTAMENTO.dbf", package = "SpatialR", lib.loc = NULL, mustWork = TRUE)
system.file("extdata", "DEPARTAMENTO.prj", package = "SpatialR", lib.loc = NULL, mustWork = TRUE)
system.file("extdata", "DEPARTAMENTO.sbn", package = "SpatialR", lib.loc = NULL, mustWork = TRUE)
system.file("extdata", "DEPARTAMENTO.sbx", package = "SpatialR", lib.loc = NULL, mustWork = TRUE)
system.file("extdata", "DEPARTAMENTO.shp.xml", package = "SpatialR", lib.loc = NULL, mustWork = TRUE)
system.file("extdata", "DEPARTAMENTO.shx", package = "SpatialR", lib.loc = NULL, mustWork = TRUE)
...
LiDAR essentially allows us to complete an aerial survey and remove the canopy layer to see what is happening below the tree line. We then have the ability to "groundtruth" the LiDAR data to see if the data match what is actually on the surface. 
