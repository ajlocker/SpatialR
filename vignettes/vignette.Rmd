...
mydata1 <-shapefile("../data-raw/Zipped_SPA_Shape_file.shp")
mydata1
head(mydata1)
```
...
DEPARTAMENTO <- shapefile("../data-raw/DEPARTAMENTO.shp")
...
SitioArqueologico <- shapefile("../data-raw/SitioArqueologico.shp")
...
dem <- raster("../data-raw/demTIN.tif")
